        ...
        <main className="bg-transparent min-h-screen text-on-background relative">
          <div className="max-w-[1200px] mx-auto px-margin-mobile lg:px-margin-desktop py-12 flex flex-col gap-24">
            ...
            >
              ...
              <div className="w-full max-w-[1000px] h-[650px] rounded-[10px] border border-outline-variant bg-[#1c1d22] shadow-2xl overflow-hidden flex flex-col relative z-10 pointer-events-none">
                {/* Terminal Header */}
